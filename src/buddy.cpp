...
// ──────────────── shared geometry ────────────────
const int BUDDY_X_CENTER = BUDDY_SCREEN_W / 2;
const int BUDDY_CANVAS_W = BUDDY_SCREEN_W;
...
void buddyRenderTo(BuddyDisplay* tgt, uint8_t personaState) {
